        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              <div class="card">
                <img src="https://catatan.nahrowi.com/wp-content/uploads/2021/08/catatan-nahrowi-product-development.png" class="card-img-top" alt="..." />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                <img src="https://productmanagementfestival.com/wp-content/uploads/2017/01/sell-your-product-online.jpg" class="card-img-top" alt="..." />
                <div class="card-body">
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
              </div>
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                <img src="https://cdn.shopify.com/s/files/1/0070/7032/files/shopify-product-sourcing.jpg?v=1598457732&width=1024" class="card-img-top" alt="..." />
                <div class="card-body">
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
              </div>
